//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Thu Dec 30 10:45:06 2021
...
//////////////////////////////////////////////////////////////////////
/*
# Exporting Component Description of DPSRAM_C2 to TCL
# Family: SmartFusion2
# Part Number: M2S010-1VF256I
# Create and Configure the core component DPSRAM_C2
create_and_configure_core -core_vlnv {Actel:SgCore:DPSRAM:1.0.102} -component_name {DPSRAM_C2} -params {\
"A_BLK_POLARITY:2"  \
"A_CLK_EDGE:RISE"  \
"A_DEPTH:10024"  \
...
"RWA_PN:A_WEN"  \
"RWB_PN:B_WEN"   }
# Exporting Component Description of DPSRAM_C2 to TCL done
*/
...
// Component instances
//--------------------------------------------------------------------
//--------DPSRAM_C2_DPSRAM_C2_0_DPSRAM   -   Actel:SgCore:DPSRAM:1.0.102
DPSRAM_C2_DPSRAM_C2_0_DPSRAM DPSRAM_C2_0(
        // Inputs
        .A_DIN  ( A_DIN ),
        .A_ADDR ( A_ADDR ),
        .B_DIN  ( B_DIN ),
