...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\time_eternity\desktop_download_doc_pic_vid_music\Desktop\industrie_and_space\pro\Image_Processing_with_low_power_demo\HF10_OV7725_LCD_FF\synthesis\TOP.vm"}
set_compile_info \
    -category {"Options"} \
